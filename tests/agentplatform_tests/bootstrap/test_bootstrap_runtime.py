...
def test_bootstrap_builds_runtime() -> None:
    ...
    assert "Research completed." in messages
    assert "Architecture analysis completed." in messages
    assert "Code generated and written." in messages
    assert "Review completed." in messages
