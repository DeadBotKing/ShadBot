...
class AgentBrain:
    ...
    def __init__(
        ...
        context_factory: BrainContextFactory | None = None,
        ...
        self._context_factory = context_factory or BrainContextFactory()
    ...
    def reason(self, *args: Any, **kwargs: Any) -> str:
        return self._reasoning.reason(*args, **kwargs)
